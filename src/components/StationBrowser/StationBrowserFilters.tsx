...
export interface StationBrowserFiltersProps {
...
const StationBrowserFilters = ({
  ...
  updateURLParams,
}: StationBrowserFiltersProps): React.JSX.Element => {
  return (
    <form
      ...
      onSubmit={(e) => {
        ...
        // Other filter changes such as changing the page number or selecting an option from a dropdown will update search params immediately.
        if (pageNum === 1) {
          updateURLParams();
        } else {
          setPageNum(1);
...
export default StationBrowserFilters;
